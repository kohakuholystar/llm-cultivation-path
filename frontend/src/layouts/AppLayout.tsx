...
const navItems = [
  { to: '/', label: '首页' }, { to: '/learn', label: '修炼之路' },
  ...
  return <div className="flex min-h-screen flex-col">
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
        <Link to="/" className="group flex items-center gap-2.5 font-semibold"><span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-brand text-base font-bold text-white shadow-glow-brand">修</span><span className="hidden bg-gradient-to-r from-brand-600 to-exp-500 bg-clip-text text-transparent sm:inline">LLM Agent 工程师修炼之路</span></Link>
