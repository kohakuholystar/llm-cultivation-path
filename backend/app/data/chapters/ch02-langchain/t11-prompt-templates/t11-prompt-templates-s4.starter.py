...
def make_sect_forge(
    ...
    """
    # TODO: 用 partial 预绑定 sect 与 format_spec,返回该门派的专用变体
    # 提示: return prompt.partial(sect=sect, format_spec=format_spec)
    raise NotImplementedError("make_sect_forge 尚未实现:请按 TODO 提示预绑定门派配置")
...
def main() -> None:
    ...
    # 提示: render_and_show(xuantie, {"request": "镇派重剑,主材玄铁精金"})
    raise NotImplementedError("main 尚未实现:请按 TODO 提示渲染两个门派变体")

    print("--- 百花谷开炉 ---")
    # TODO: 用 baihua 渲染一次,只传 {"request": ...},打印结果
    # 提示: render_and_show(baihua, {"request": "一柄缠枝细剑,主材精钢"})
    raise NotImplementedError("main 尚未实现:请按 TODO 提示渲染两个门派变体")
