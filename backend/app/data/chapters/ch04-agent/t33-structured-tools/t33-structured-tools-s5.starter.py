...
def refine_calc(item_name: str, quantity: int, unit_cost: float, rarity: str = "凡品") -> str:
    ...
    # TODO: 加业务约束:仙品一次最多炼 5 件,超出则抛 ToolException
    # 提示: if rarity == "仙品" and quantity > 5: raise ToolException(f"炉火不足:仙品法器一次最多炼 5 件(收到 {quantity} 件)")
    raise NotImplementedError("t33-s5 尚未实现:请按 TODO 提示加上仙品数量约束")
